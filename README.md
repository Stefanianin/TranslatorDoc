...
1. Creează un repo pe GitHub (ex. `translator-docs-web`).
2. Încarcă conținutul folderului `TranslatorDocsWeb` (doar fișierele din interior: `index.html`, `styles.css`, `app.js`, `catalog.json`).
